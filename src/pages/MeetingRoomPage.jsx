...
const FAKE_PARTICIPANTS = ['Alex', 'Jordan', 'Sam', 'Morgan']
                    ...
                    <>
                      <div className="flex gap-2">
                        ...
                        <div className="bg-secondary rounded-lg px-3 py-2">
                          <p className="text-[10px] text-muted-foreground mb-1">Alex</p>
                          <p className="text-xs text-foreground">Hey everyone, ready to start?</p>
                        </div>
                      </div>
                      <div className="flex gap-2 justify-end">
                        <div className="bg-primary/20 rounded-lg px-3 py-2">
                          <p className="text-xs text-foreground">Yes, let's go!</p>
                        </div>
                        <Avatar className="h-6 w-6 shrink-0">
